...
public class fragmentMojePrispevky extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                            ...
                            if (doc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if (isFirstPageFirstLoad) {
                                    if(cardPrispevok.getIdPouzivatela().equals(userId))oblubene_list.add(cardPrispevok);
                                    ...
                                    if(cardPrispevok.getIdPouzivatela().equals(userId))oblubene_list.add(0, cardPrispevok);
            ...
            Log.d("bundle odoslany", "nepreslo to");
        }
        return view;
    }

    public void loadMorePost(final String paUser){

        if(firebaseAuth.getCurrentUser() != null) {

            Query nextQuery = firebaseFirestore.collection("prispevky").startAfter(lastVisible).limit(100);
                    ...
                    if (!documentSnapshots.isEmpty()) {
                        ...
                        for (DocumentChange doc : documentSnapshots.getDocumentChanges()) {
                            ...
                            if (doc.getType() == DocumentChange.Type.ADDED) {
                                ...
                                if(cardPrispevok.getIdPouzivatela().equals(paUser))oblubene_list.add(cardPrispevok);
